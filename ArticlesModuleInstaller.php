 ...
 *
 * @package    KaikmediaArticlesModule
 * @author     Kaik <contact@kaikmedia.com>
 * @copyright  KaikMedia
 * @link       https://github.com/Kaik/KaikMediaArticles.git
 */

namespace Kaikmedia\ArticlesModule;

//use Zikula\CategoriesModule\Entity\CategoryAttributeEntity;
//use Zikula\CategoriesModule\Entity\CategoryEntity;
//use Zikula\CategoriesModule\Entity\CategoryRegistryEntity;
use Zikula\Core\AbstractExtensionInstaller;
//use Kaikmedia\InformatorModule\Entity\CategoryAssignmentEntity;
//use Kaikmedia\InformatorModule\Entity\InformationEntity;

class ArticlesModuleInstaller extends AbstractExtensionInstaller
{
//    /**
//     * @var \
//     */
//    private $entities = [
//        InformatorEntity::class,
